...
| orphan: source DB deleted | 1 | Warning | n/a | S2, S4 | `orphan: source DB deleted` | — |
| automated age > parent `BackupRetentionPeriod` | 1 | Warning | n/a | S2, S4 | `automated, <N>d past retention` | — |
