...
- **How discovered**: Backup plans whose selections name the snapshot's source cluster by ARN or select it by its tags ([working-with-supported-services](https://docs.aws.amazon.com/aws-backup/latest/devguide/working-with-supported-services.html)).
