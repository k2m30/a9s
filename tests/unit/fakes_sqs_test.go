...
//
// fakeSQSListQueuesOnly and fakeSQSGetQueueAttributesWithKMS are in
// aws_related_checker_round2_test.go: package unit_test cannot reach these
// unexported package-unit fakes.
//
