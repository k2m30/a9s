...
var knownDisconnectedPivots = map[string]bool{
	...
	"ebs-snap:backup": true, "ebs-snap:ec2": true,
	"ebs:backup": true,
	"ec2:backup": true, "ec2:ssm": true,
	"ecr:cb": true, "ecr:cfn": true, "ecr:ct-events": true, "ecr:eb-rule": true,
	"ecr:ecs-task": true, "ecr:pipeline": true, "ecr:role": true,
	"ecs-svc:elb": true, "ecs-svc:sfn": true,
	"ecs-task:role": true, "ecs-task:secrets": true, "ecs-task:sg": true,
	"ecs-task:ssm": true,
	...
	"lambda:cf": true, "lambda:cfn": true, "lambda:ecr": true,
	"lambda:eni": true, "lambda:tg": true,
	...
	"tg:dbi-snap": true, "tg:lambda": true, "tg:logs": true, "tg:sg": true, "tg:subnet": true,
