...
var knownDisconnectedPivots = map[string]bool{
	"alarm:asg": true, "alarm:ct-events": true,
	"alarm:kms":  true,
	"alarm:logs": true, "alarm:s3": true, "alarm:waf": true,
	"apigw:elb": true, "apigw:r53": true,
	"apigw:role": true, "apigw:sfn": true, "apigw:sns": true, "apigw:vpce": true, "apigw:waf": true,
	"asg:alarm": true, "asg:role": true, "asg:sns": true,
	...
	"eb-rule:kinesis": true, "eb-rule:logs": true,
	"ebs-snap:ec2": true,
	...
	"logs:alarm": true, "logs:ecs-task": true, "logs:kinesis": true, "logs:s3": true,
	...
	"subnet:asg": true, "subnet:efs": true, "subnet:eks": true,
	...
	"vpce:acm": true, "vpce:cf": true, "vpce:logs": true, "vpce:r53": true,
