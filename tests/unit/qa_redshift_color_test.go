...
func TestRedshiftColor(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:   "resizing",
			fields: map[string]string{"status": "resizing"},
			want:   resource.ColorWarning,
		},
		{
			name:   "rebooting",
		...
		{
			name:   "renaming",
			fields: map[string]string{"status": "renaming"},
			want:   resource.ColorWarning,
		},
		{
			name:   "deleting",
		...
		},
		{
			...
			fields: map[string]string{"status": "incompatible-hsm"},
		...
		},
		{
			...
			fields: map[string]string{"status": "hardware-failure"},
			want:   resource.ColorBroken,
		},
		{
			name:   "storage_full",
		...
		},
		{
			...
			fields: map[string]string{"status": "available", "cluster_availability_status": "Unavailable"},
			want:   resource.ColorBroken,
		},
		{
			name:   "availability_failed",
			fields: map[string]string{"status": "available", "cluster_availability_status": "Failed"},
			want:   resource.ColorBroken,
		},
		{
			name:   "availability_maintenance",
			fields: map[string]string{"status": "available", "cluster_availability_status": "Maintenance"},
			want:   resource.ColorWarning,
		},
		{
			name:   "availability_modifying",
			fields: map[string]string{"status": "available", "cluster_availability_status": "Modifying"},
			want:   resource.ColorWarning,
		},
		{
