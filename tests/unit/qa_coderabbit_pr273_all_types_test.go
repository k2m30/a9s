...
var typeContracts = []typeContract{
	...
	{shortName: "athena", apiDoc: "https://docs.aws.amazon.com/athena/latest/APIReference/API_ListWorkGroups.html", statusField: "state", reasoning: "Athena WorkGroup state is ENABLED | DISABLED; neither is a fault — DISABLED is a deliberate admin action."},
