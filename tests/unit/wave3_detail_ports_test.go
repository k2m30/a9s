// wave3_detail_ports_test.go — Wave 3 (specs/022-codebase-cleanup) port pins
// for the DetailModel legacy-view deletion, per specs/022-codebase-cleanup/
...
//     (TestWave3_RenderDetail_Golden_FieldsAttentionRelatedPanel).
...
func TestWave3_RenderDetail_Golden_FieldsAttentionRelatedPanel(t *testing.T) {
	tuitest.NoColor(t)
...
// TestWave3_FooterHints_Detail_NavigableFieldHint pins that when FieldCursor
...
func TestWave3_FooterHints_Detail_NavigableFieldHint(t *testing.T) {
...
// TestWave3_Detail_EnterOnNavigableField_TUIKeyRoute_NavigatesToTarget drives
...
func TestWave3_Detail_EnterOnNavigableField_TUIKeyRoute_NavigatesToTarget(t *testing.T) {
...
// TestWave3_FooterHints_Detail_TabSuppressedOnAutoShow_ThenShownOnExplicitToggle
...
func TestWave3_FooterHints_Detail_TabSuppressedOnAutoShow_ThenShownOnExplicitToggle(t *testing.T) {
...
// TestWave3_FooterHints_Detail_CloudTrailHint pins that the "t: CloudTrail"
...
func TestWave3_FooterHints_Detail_CloudTrailHint(t *testing.T) {
...
// TestWave3_FooterHints_Detail_RightColFocused_ShowsCloudTrail pins that the
...
// left-column branch TestWave3_FooterHints_Detail_CloudTrailHint exercises.
// Live replacement for qa_bottom_hints_test.go's
// TestBottomHints_Detail_RightColFocused_ShowsCloudTrail.
func TestWave3_FooterHints_Detail_RightColFocused_ShowsCloudTrail(t *testing.T) {
...
// TestWave3_FooterHints_YAML_CloudTrailHint pins that a YAML/text screen's
...
// before this pin.
func TestWave3_FooterHints_YAML_CloudTrailHint(t *testing.T) {
...
// TestWave3_DetailSearch_LiveSeam_ActivateHighlightNextPrevEsc drives the
...
func TestWave3_DetailSearch_LiveSeam_ActivateHighlightNextPrevEsc(t *testing.T) {
...
// TestWave3_RenderDetail_SectionHeader_BoldNoColor pins that an IsSection row
...
func TestWave3_RenderDetail_SectionHeader_BoldNoColor(t *testing.T) {
	tuitest.ForceColor(t)
...
// TestWave3_RenderDetail_ColorTier_IsNavigableWinsOverColorTier pins that a
...
func TestWave3_RenderDetail_ColorTier_IsNavigableWinsOverColorTier(t *testing.T) {
	tuitest.ForceColor(t)
...
// TestWave3_RenderDetail_ColorTier_LabelAlwaysNeutral pins that the label
...
// and friends.
func TestWave3_RenderDetail_ColorTier_LabelAlwaysNeutral(t *testing.T) {
	tuitest.ForceColor(t)
...
// TestWave3_CTEvents_LiveProjector_SectionHeadersPresentInOrder pins that a
...
func TestWave3_CTEvents_LiveProjector_SectionHeadersPresentInOrder(t *testing.T) {
...
// TestWave3_CTEvents_LiveProjector_DataRowsBetweenSections pins the one claim
// TestWave3_CTEvents_LiveProjector_SectionHeadersPresentInOrder above does
...
func TestWave3_CTEvents_LiveProjector_DataRowsBetweenSections(t *testing.T) {
	res := buildCTEventsResource(
...
// TestWave3_TierColorStyle_CtEventTiersAreDistinct pins that styles.
...
// separately by TestWave3_RenderDetail_ColorTier_IsNavigableWinsOverColorTier
// and TestWave3_RenderDetail_ColorTier_LabelAlwaysNeutral above (using "ct-
// danger"/"!" as representative non-empty ColorTier values — the renderer
// branch is tier-string-agnostic).
func TestWave3_TierColorStyle_CtEventTiersAreDistinct(t *testing.T) {
	tuitest.ForceColor(t)
...
// TestWave3_ActionCloudTrail_Detail_DispatchesCtEventsFetchFiltered pins that
...
func TestWave3_ActionCloudTrail_Detail_DispatchesCtEventsFetchFiltered(t *testing.T) {
...
// TestWave3_ActionCloudTrail_NoCloudTrailKey_DispatchesNothing pins the
// negative case: a resource type without a CloudTrailKey no-ops.
func TestWave3_ActionCloudTrail_NoCloudTrailKey_DispatchesNothing(t *testing.T) {
...
// TestWave3_DetailController_MoveDown_ClampsAtLastField pins the boundary
...
func TestWave3_DetailController_MoveDown_ClampsAtLastField(t *testing.T) {
	c := newDetailController(t, detailParityEC2Resource(), "ec2")
...
// TestWave3_DetailController_MoveUp_ClampsAtFirstField pins the symmetric
...
func TestWave3_DetailController_MoveUp_ClampsAtFirstField(t *testing.T) {
	c := newDetailController(t, detailParityEC2Resource(), "ec2")
...
// TestWave3_DetailAttention_RendersFullDetailSentence_AlongsidePhrase pins
...
// wave3-map-detail.md).
func TestWave3_DetailAttention_RendersFullDetailSentence_AlongsidePhrase(t *testing.T) {
...
// TestWave3_DetailAttention_FallsBackToPhrase_WhenDetailEmpty pins that when
...
func TestWave3_DetailAttention_FallsBackToPhrase_WhenDetailEmpty(t *testing.T) {
...
// TestWave3_RenderDetail_RelatedPanel_ScrollExceedsRowCount is ported from
...
func TestWave3_RenderDetail_RelatedPanel_ScrollExceedsRowCount(t *testing.T) {
	tuitest.NoColor(t)
...
func TestWave3_DetailFooterHints_PlainField_NoRelated(t *testing.T) {
...
func TestWave3_DetailFooterHints_PlainField_WithRelated(t *testing.T) {
...
func TestWave3_DetailCursor_ClearFinding_PreservesCursorIdentity(t *testing.T) {
	res := resource.Resource{
		ID:   "db-2",
		Name: "prod-db-2",
		Fields: map[string]string{
