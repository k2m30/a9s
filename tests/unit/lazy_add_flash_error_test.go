...
//	    flashCmd := func() tea.Msg { return messages.Flash{...} }
...
func collectFlashMsg(cmd tea.Cmd) (messages.Flash, bool) {
	if cmd == nil {
...
func findFlashInMsg(msg tea.Msg) (messages.Flash, bool) {
	switch v := msg.(type) {
	case messages.Flash:
		return v, true
	case tea.BatchMsg:
...
func TestLazyAddError_EmitsFlashMsg(t *testing.T) {
	...
	m, startCmd := rootApplyMsg(m, messages.RelatedCheckStarted{
