	...
	return []resource.Resource{
		{
			...
			Fields: map[string]string{
				...
				"last_modified": "2026-03-01 12:00",
			},
		},
		{
			ID:     "data-processor",
			...
			Fields: map[string]string{
				...
				"last_modified": "2026-02-15 08:30",
			},
		},
	}
}
	...
	return []resource.Resource{
		{
			...
			Fields: map[string]string{
				...
				"status":       "CREATE_COMPLETE",
				"creation_time": "2026-01-15 10:00",
				"last_updated": "2026-03-01 14:30",
	...
	return []resource.Resource{
		{
			...
			Fields: map[string]string{
				...
				"type":          "SecureString",
				"version":       "3",
				"last_modified": "2026-02-28 16:00",
	...
	return []resource.Resource{
		{
			...
			Fields: map[string]string{
				...
				"path":               "/",
				"create_date":        "2025-01-15 12:00",
				"password_last_used": "2026-03-19 08:00",
			},
		},
	}
}
