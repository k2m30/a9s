		...
		},
		{
			...
			RawStruct: &ekstypes.Cluster{
				...
				ResourcesVpcConfig: &ekstypes.VpcConfigResponse{
					...
					ClusterSecurityGroupId: aws.String("sg-0ddd444444444444d"),
					EndpointPublicAccess:   true,
		...
		},
		{
			...
			RawStruct: &ekstypes.Cluster{
				...
				ResourcesVpcConfig: &ekstypes.VpcConfigResponse{
					...
					SubnetIds:              []string{"subnet-0bbb222222222222b"},
					SecurityGroupIds:       []string{"sg-0bbb222222222222b"},
					ClusterSecurityGroupId: aws.String("sg-0fff888888888888f"),
					EndpointPublicAccess:   true,
					EndpointPrivateAccess:  false,
				},
				Tags: map[string]string{
...
func nodegroupFixtures() []resource.Resource {
	return []resource.Resource{
		...
		{
			ID:     "staging-general",
			Name:   "staging-general",
			Status: "ACTIVE",
			Fields: map[string]string{
				"nodegroup_name": "staging-general",
				"cluster_name":   "acme-staging",
				"status":         "ACTIVE",
			...
			RawStruct: ekstypes.Nodegroup{
				NodegroupName: aws.String("staging-general"),
				ClusterName:   aws.String("acme-staging"),
				NodegroupArn:  aws.String("arn:aws:eks:us-east-1:123456789012:nodegroup/acme-staging/staging-general/42345678-1234-1234-1234-123456789012"),
				Status:        ekstypes.NodegroupStatusActive,
				...
				NodeRole:       aws.String("arn:aws:iam::123456789012:role/eks-node-role"),
				Subnets:        []string{stagingSubnetA, stagingSubnetB},
				ReleaseVersion: aws.String("1.28.2-20260301"),
				Version:        aws.String("1.28"),
				CreatedAt:      aws.Time(mustParseTime("2025-11-10T10:00:00Z")),
			},
		},
		{
			ID:     "dev-general",
			...
			RawStruct: ekstypes.Nodegroup{
				NodegroupName: aws.String("dev-general"),
				ClusterName:   aws.String("acme-dev"),
				NodegroupArn:  aws.String("arn:aws:eks:us-east-1:123456789012:nodegroup/acme-dev/dev-general/52345678-1234-1234-1234-123456789012"),
				Status:        ekstypes.NodegroupStatusActive,
				...
				NodeRole:       aws.String("arn:aws:iam::123456789012:role/eks-node-role"),
				Subnets:        []string{stagingSubnetA},
				ReleaseVersion: aws.String("1.27.9-20260215"),
				Version:        aws.String("1.27"),
				CreatedAt:      aws.Time(mustParseTime("2026-01-12T09:00:00Z")),
			},
		},
	}
}
