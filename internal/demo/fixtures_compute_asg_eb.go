...
func asgFixtures() []resource.Resource {
	return []resource.Resource{
		...
		{
			ID:     "awseb-e-acmeprodapi-asg",
			Name:   "awseb-e-acmeprodapi-asg",
			Status: "",
			Fields: map[string]string{
				"asg_name":  "awseb-e-acmeprodapi-asg",
				"min_size":  "1",
				"max_size":  "4",
				"desired":   "2",
				"instances": "2",
			...
			RawStruct: asgtypes.AutoScalingGroup{
				...
				AutoScalingGroupARN:  aws.String("arn:aws:autoscaling:us-east-1:123456789012:autoScalingGroup:52345678-1234-1234-1234-123456789012:autoScalingGroupName/awseb-e-acmeprodapi-asg"),
				MinSize:              aws.Int32(1),
				MaxSize:              aws.Int32(4),
				DesiredCapacity:      aws.Int32(2),
				AvailabilityZones:    []string{"us-east-1a", "us-east-1b"},
				...
				HealthCheckGracePeriod: aws.Int32(300),
				DefaultCooldown:      aws.Int32(300),
				CreatedTime:          aws.Time(mustParseTime("2025-05-20T10:00:00Z")),
				VPCZoneIdentifier:    aws.String("subnet-0ccc333333333333c,subnet-0ddd444444444444d"),
				TerminationPolicies:  []string{"Default"},
				Instances: []asgtypes.Instance{
					{InstanceId: aws.String("i-0e1b2c3d4e5f60001"), AvailabilityZone: aws.String("us-east-1a"), HealthStatus: aws.String("Healthy"), LifecycleState: asgtypes.LifecycleStateInService},
					{InstanceId: aws.String("i-0e1b2c3d4e5f60002"), AvailabilityZone: aws.String("us-east-1b"), HealthStatus: aws.String("Healthy"), LifecycleState: asgtypes.LifecycleStateInService},
				},
				Tags: []asgtypes.TagDescription{
					{Key: aws.String("elasticbeanstalk:environment-name"), Value: aws.String("e-acmeprodapi"), ResourceId: aws.String("awseb-e-acmeprodapi-asg"), ResourceType: aws.String("auto-scaling-group"), PropagateAtLaunch: aws.Bool(true)},
					{Key: aws.String("Environment"), Value: aws.String("prod"), ResourceId: aws.String("awseb-e-acmeprodapi-asg"), ResourceType: aws.String("auto-scaling-group"), PropagateAtLaunch: aws.Bool(true)},
				},
			},
		},
		{
