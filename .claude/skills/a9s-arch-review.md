...
- `core/aws/<service>_interfaces.go` files may individually exceed 500 lines for services with many narrow operation interfaces (EC2, IAM). Growth is linear with resource types; each interface is ~3 lines. Acceptable.
