...
var computeTypes = []catalog.ResourceTypeDef{ //nolint:gochecknoglobals // static catalog: intentional package-level var
	{
		...
		Findings: []catalog.FindingDef{
			...
			{Code: ec2CodeScheduledEvent, Phrase: "scheduled event", Severity: domain.SevWarn, Source: "wave2"},
	...
	},
	{
		...
		Findings: []catalog.FindingDef{
			...
			{Code: ecsCodeClusterIssue, Phrase: "tasks pending or not running", Severity: domain.SevWarn, Source: "wave2"},
		},
	},
	{
		Name:           "ECS Tasks",
