...
var computeTypes = []catalog.ResourceTypeDef{ //nolint:gochecknoglobals // static catalog: intentional package-level var
	...
	},
	{
		...
		Related: []domain.RelatedDef{
			...
			{TargetType: "ct-events", DisplayName: "CloudTrail Events", Checker: checkECSSvcCTEvents, NeedsTargetCache: true, Truncated: true},
	...
	},
	{
		...
		Related: []domain.RelatedDef{
			...
			{TargetType: "ct-events", DisplayName: "CloudTrail Events", Checker: checkECSCTEvents, NeedsTargetCache: true, Truncated: true},
	...
	},
	{
		...
		Related: []domain.RelatedDef{
			...
			{TargetType: "ct-events", DisplayName: "CloudTrail Events", Checker: checkECSTaskCTEvents, NeedsTargetCache: true, Truncated: true},
	...
	},
	{
		...
		Related: []domain.RelatedDef{
			...
			{TargetType: "sqs", DisplayName: "SQS Queues", Checker: checkLambdaSQS, Truncated: true},
			...
			{TargetType: "ddb", DisplayName: "DynamoDB Tables", Checker: checkLambdaDDB, Truncated: true},
			{TargetType: "kinesis", DisplayName: "Kinesis Streams", Checker: checkLambdaKinesis, Truncated: true},
			{TargetType: "msk", DisplayName: "MSK Clusters", Checker: checkLambdaMSK, Truncated: true},
			{TargetType: "ct-events", DisplayName: "CloudTrail Events", Checker: checkLambdaCTEvents, NeedsTargetCache: true, Truncated: true},
	...
	},
	{
		...
		Related: []domain.RelatedDef{
			...
			{TargetType: "ebs", DisplayName: "EBS Volume", Checker: checkEBSSnapEBS, NeedsTargetCache: false, Truncated: true},
			{TargetType: "ec2", DisplayName: "EC2 Instance", Checker: checkEBSSnapEC2, NeedsTargetCache: true, Truncated: true},
