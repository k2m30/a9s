...
var monitoringTypes = []catalog.ResourceTypeDef{ //nolint:gochecknoglobals // static catalog: intentional package-level var
	{
		...
		Related: []domain.RelatedDef{
			{TargetType: "sns", DisplayName: "SNS Topics", Checker: checkAlarmSNS, NeedsTargetCache: true, Truncated: true},
			{TargetType: "asg", DisplayName: "Auto Scaling Groups", Checker: checkAlarmASG, NeedsTargetCache: true, Truncated: true},
			{TargetType: "apigw", DisplayName: "API Gateways", Checker: checkAlarmAPIGW, NeedsTargetCache: true, Truncated: true},
			{TargetType: "cb", DisplayName: "CodeBuild Projects", Checker: checkAlarmCB, NeedsTargetCache: true, Truncated: true},
			{TargetType: "dbi", DisplayName: "RDS Instances", Checker: checkAlarmDBI, NeedsTargetCache: true, Truncated: true},
			{TargetType: "ec2", DisplayName: "EC2 Instances", Checker: checkAlarmEC2, NeedsTargetCache: true, Truncated: true},
			{TargetType: "ecs", DisplayName: "ECS Clusters", Checker: checkAlarmECS, NeedsTargetCache: true, Truncated: true},
			{TargetType: "eks", DisplayName: "EKS Clusters", Checker: checkAlarmEKS, NeedsTargetCache: true, Truncated: true},
			{TargetType: "kms", DisplayName: "KMS Keys", Checker: checkAlarmKMS, NeedsTargetCache: true, Truncated: true},
			{TargetType: "lambda", DisplayName: "Lambda Functions", Checker: checkAlarmLambda, NeedsTargetCache: true, Truncated: true},
			{TargetType: "logs", DisplayName: "Log Groups", Checker: checkAlarmLogs, NeedsTargetCache: true, Truncated: true},
	...
	},
	{
		...
		Related: []domain.RelatedDef{
			...
			{TargetType: "ec2", DisplayName: "EC2 Instances", Checker: checkCtEventsEC2, NeedsTargetCache: false, Truncated: true},
			{TargetType: "s3", DisplayName: "S3 Buckets", Checker: checkCtEventsS3, NeedsTargetCache: false, Truncated: true},
			{TargetType: "lambda", DisplayName: "Lambda Functions", Checker: checkCtEventsLambda, NeedsTargetCache: false, Truncated: true},
			{TargetType: "dbi", DisplayName: "RDS Instances", Checker: checkCtEventsRDS, NeedsTargetCache: false, Truncated: true},
			{TargetType: "kms", DisplayName: "KMS Keys", Checker: checkCtEventsKMS, NeedsTargetCache: false, Truncated: true},
			{TargetType: "secrets", DisplayName: "Secrets", Checker: checkCtEventsSecrets, NeedsTargetCache: false, Truncated: true},
			{TargetType: "vpce", DisplayName: "VPC Endpoints", Checker: checkCtEventsVPCE, NeedsTargetCache: false, Truncated: true},
			{TargetType: "sg", DisplayName: "Security Groups", Checker: checkCtEventsSG, NeedsTargetCache: false, Truncated: true},
			{TargetType: "ddb", DisplayName: "DynamoDB Tables", Checker: checkCtEventsDDB, NeedsTargetCache: false, Truncated: true},
			{TargetType: "ecr", DisplayName: "ECR Repositories", Checker: checkCtEventsECR, NeedsTargetCache: false, Truncated: true},
			{TargetType: "cfn", DisplayName: "CloudFormation Stacks", Checker: checkCtEventsCFN, NeedsTargetCache: false, Truncated: true},
			{TargetType: "trail", DisplayName: "CloudTrail Trails", Checker: checkCtEventsTrail, NeedsTargetCache: false, Truncated: true},
