...
var dnsCdnTypes = []catalog.ResourceTypeDef{ //nolint:gochecknoglobals // static catalog: intentional package-level var
	...
	},
	{
		...
		Related: []domain.RelatedDef{
			...
			{TargetType: "elb", DisplayName: "Load Balancers (origin)", Checker: checkCfELB, Truncated: true, Mirror: true},
			{TargetType: "waf", DisplayName: "WAF Web ACLs", Checker: checkCfWAF, NeedsTargetCache: true, Truncated: true, Mirror: true},
			{TargetType: "acm", DisplayName: "ACM Certificates", Checker: checkCfACM, Truncated: true, Mirror: true},
			{TargetType: "r53", DisplayName: "Route 53 Zones", Checker: checkCfR53, Truncated: true, Mirror: true},
			{TargetType: "alarm", DisplayName: "CloudWatch Alarms", Checker: checkCfAlarm, Truncated: true},
