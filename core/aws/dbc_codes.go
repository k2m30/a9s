...
const (
	...
	CodeDBCEncryptionKeyRecoverable domain.FindingCode = "dbc.broken.encryption_key_recoverable"
	CodeDBCCloningFailed            domain.FindingCode = "dbc.broken.cloning_failed"
	CodeDBCMigrationFailed          domain.FindingCode = "dbc.broken.migration_failed"
	CodeDBCUpgradeFailed            domain.FindingCode = "dbc.broken.upgrade_failed"
	CodeDBCStopped                  domain.FindingCode = "dbc.broken.stopped"

	CodeDBCTransitional          domain.FindingCode = "dbc.warn.transitional"
	CodeDBCUnrecognisedStatus    domain.FindingCode = "dbc.warn.unrecognised_status"
