...
var messagingTypes = []catalog.ResourceTypeDef{ //nolint:gochecknoglobals // static catalog: intentional package-level var
	{
		...
		Related: []domain.RelatedDef{
			...
			{TargetType: "lambda", DisplayName: "Lambda Functions", Checker: checkSQSLambda, NeedsTargetCache: false, Truncated: true},
			...
			{TargetType: "eb-rule", DisplayName: "EventBridge Rules", Checker: checkSQSEbRule, NeedsTargetCache: true, Truncated: true},
	...
	},
	{
		...
		Related: []domain.RelatedDef{
			...
			{TargetType: "lambda", DisplayName: "Lambda (targets)", Checker: checkEbRuleLambda, Truncated: true},
			{TargetType: "logs", DisplayName: "Log Groups (targets)", Checker: checkEbRuleLogs, Truncated: true},
			{TargetType: "sfn", DisplayName: "Step Functions (targets)", Checker: checkEbRuleSFN, Truncated: true},
	...
	},
	{
		...
		Related: []domain.RelatedDef{
			...
			{TargetType: "lambda", DisplayName: "Lambda Functions", Checker: checkMSKLambda, NeedsTargetCache: true, Truncated: true},
	...
	},
	{
		...
		Related: []domain.RelatedDef{
			...
			{TargetType: "eb-rule", DisplayName: "EventBridge Rules", Checker: checkSFNEbRule, NeedsTargetCache: true, Truncated: true},
