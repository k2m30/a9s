...
var secretsTypes = []catalog.ResourceTypeDef{ //nolint:gochecknoglobals // static catalog: intentional package-level var
	{
		...
		Related: []domain.RelatedDef{
			{TargetType: "kms", DisplayName: "KMS Keys", Checker: checkSecretsKMS, NeedsTargetCache: true, Truncated: true, Mirror: true},
			{TargetType: "lambda", DisplayName: "Lambda (rotation)", Checker: checkSecretsLambda, NeedsTargetCache: true, Truncated: true, Distinct: "the rotation function in SecretListEntry.RotationLambdaARN"},
			...
			{TargetType: "role", DisplayName: "IAM Roles", Checker: checkSecretsRole, Truncated: true},
	...
	},
	{
		...
		Related: []domain.RelatedDef{
			...
			{TargetType: "dbi", DisplayName: "RDS Instances", Checker: checkKMSRDS, NeedsTargetCache: true, Truncated: true, Mirror: true},
			{TargetType: "secrets", DisplayName: "Secrets Manager", Checker: checkKMSSecrets, NeedsTargetCache: true, Truncated: true, Mirror: true},
			{TargetType: "role", DisplayName: "IAM Roles (grants)", Checker: checkKMSRole, NeedsTargetCache: false, Truncated: true},
