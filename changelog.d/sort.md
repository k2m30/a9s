...
- Narrow columns keep their sort arrow. A column just wide enough for its title used to lose the arrow to the ellipsis, so the header read as unsorted while the rows below it were sorted.
